<?php
/** ---------------------------------------------------------------------
 * museesDeFrance/lib/inventaire/InventaireTablesUpdater.php
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
class InventaireTablesUpdater {
    ...
    static function performDatabaseUpdate($pn_version, $pa_options=null) {
        ...
        $vs_update_file = __CA_BASE_DIR__."app/plugins/museesDeFrance/assets/sql/updates/{$pn_version}.sql";
        if (!file_exists($vs_update_file)) { return null; }
        $o_handle = fopen($vs_update_file, "r");
